...
@Mojo(name = "hbm2service", defaultPhase = GENERATE_SOURCES)
public class GenerateServiceMojo extends AbstractGenerationMojo {
    ...
    protected void executeExporter(MetadataDescriptor metadataDescriptor) {
        Exporter pojoExporter = ExporterFactory.createExporter(NextExporterType.SERVICE.className());
        ...
        getLog().info("Starting Service export to directory: " + outputDirectory + "...");
        pojoExporter.start();
    }
